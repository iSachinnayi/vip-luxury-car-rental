// ═══════════════════════════════════════════════
//  Brand Listing Page — /brand
//  Grid of all available car brands
// ═══════════════════════════════════════════════
...
const BRANDS = [
  ...new Set(sampleCars.map((c) => c.brand)),
].sort();
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pb-16">
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">
            Choose from {BRANDS.length} premium car brands
          </p>
        </div>
          ...
          {BRANDS.map((brand) => {
            ...
            return (
              <Link
                key={brand}
                href={`/${slug}`}
                className="group p-6 md:p-8 rounded-2xl glass-card 
                           hover:border-gold/30 hover:bg-white/[0.05] transition-all text-center"
              >
                <div className="font-serif text-lg md:text-2xl font-bold text-white 
